...
export const deliveryAPI = {
  ...
  deliver: (id, otp) =>
    api.post(`/deliveries/${id}/deliver`, null, {
      params: { otp },
    }),
...
export const aiAPI = {
  recommend: (productId, topN = 5) =>
    aiApi.post('/recommendations/recommend', {
      product_id: productId,
      top_n: topN,
    }),

  forecast: (data) =>
    aiApi.post('/forecast/predict', data),

  chat: (question, history = [], shopContext = []) =>
    aiApi.post('/chatbot/ask', {
      question,
  ...
  sentiment: (text) =>
    aiApi.post('/sentiment/analyze', { text }),

  comparePrices: (data) =>
    aiApi.post('/price/compare', data),
}
